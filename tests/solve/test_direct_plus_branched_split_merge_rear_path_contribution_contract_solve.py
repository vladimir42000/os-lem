...
def test_solve_frequency_sweep_supports_direct_plus_branched_split_merge_rear_path_contribution_contract() -> None:
...
def test_direct_plus_branched_split_merge_rear_path_contribution_spl_is_finite_and_distinct() -> None:
    model, warnings = normalize_model(build_direct_plus_branched_split_merge_rear_path_model_dict())
    assert warnings == []
    system = assemble_system(model)
