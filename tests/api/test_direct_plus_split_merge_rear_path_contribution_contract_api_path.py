...
def test_run_simulation_supports_direct_plus_split_merge_rear_path_contribution_contract() -> None:
    ...
    expected_front = direct_plus_split_merge_rear_path_front_contribution_spl(
        sweep,
        system,
        contract,
        1.0,
    ...
    expected_rear = direct_plus_split_merge_rear_path_rear_contribution_spl(
        sweep,
        system,
        contract,
        1.0,
