...
def test_assemble_system_collects_one_dual_radiator_topology() -> None:
    ...
    topology = assembled.dual_radiator_topologies[0]
...
def test_assemble_system_does_not_claim_dual_radiator_topology_without_front_radiator() -> None:
