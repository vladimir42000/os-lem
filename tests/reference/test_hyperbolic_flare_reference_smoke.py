...
from os_lem.reference_hyperbolic_flare_smoke import (
    _relative_l2_change,
    _relative_scalar_change,
    build_hyperbolic_model_with_segments,
    downsample_boundary_profile,
    evaluate_hyperbolic_reference_smoke,
)


def test_hyperbolic_reference_smoke_remains_finite_endpoint_consistent_and_refinement_bounded() -> None:
    report = evaluate_hyperbolic_reference_smoke(
        build_hyperbolic_model_with_segments,
