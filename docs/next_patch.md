...
- `docs/v0.7.0-three-law-named-flare-checkpoint-note`

Purpose:
- freeze the meaning of the accepted three-law named-flare checkpoint
- keep current `v0.7.0` reading bounded and coherent
- avoid silently opening a fourth-law step or broader flare-family growth by momentum

## Post-landing reading

After this docs/control patch lands:
- no next technical flare step is opened by default
- no fourth flare law is authorized by implication
