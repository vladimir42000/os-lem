...
def direct_plus_split_merge_rear_path_front_contribution_pressure(
    sweep: SolvedFrequencySweep,
    system: AssembledSystem,
    contract: DirectPlusSplitMergeRearPathContributionContract,
    distance_m: float,
    *,
    radiation_space: str | None = None,
    observable_contract: str | None = None,
) -> np.ndarray:
    """Return the direct-front contribution pressure for one split/merge rear contract."""
...
def direct_plus_split_merge_rear_path_front_contribution_spl(
    sweep: SolvedFrequencySweep,
    system: AssembledSystem,
    contract: DirectPlusSplitMergeRearPathContributionContract,
    distance_m: float,
    *,
    ...
    """Return the direct-front contribution SPL for one split/merge rear contract."""

    p_obs = direct_plus_split_merge_rear_path_front_contribution_pressure(
        sweep,
        system,
        contract,
        distance_m,
...
def direct_plus_split_merge_rear_path_rear_contribution_pressure(
    sweep: SolvedFrequencySweep,
    system: AssembledSystem,
    contract: DirectPlusSplitMergeRearPathContributionContract,
    distance_m: float,
    *,
    ...
    """Return the recombined rear contribution pressure for one split/merge rear contract."""

    return radiator_observation_pressure(
        sweep,
        system,
        contract.rear_mouth_radiator_id,
        distance_m,
        radiation_space=radiation_space,
        observable_contract=observable_contract,
    )
...
def direct_plus_split_merge_rear_path_rear_contribution_spl(
    sweep: SolvedFrequencySweep,
    system: AssembledSystem,
    contract: DirectPlusSplitMergeRearPathContributionContract,
    distance_m: float,
...
def direct_plus_branched_split_merge_rear_path_front_chamber_throat_side_front_contribution_pressure(
    sweep: SolvedFrequencySweep,
    system: AssembledSystem,
    contract: DirectPlusBranchedSplitMergeRearPathFrontChamberThroatSideContributionContract,
    distance_m: float,
    *,
    radiation_space: str | None = None,
    observable_contract: str | None = None,
) -> np.ndarray:
    """Return the direct-front contribution pressure for one front-coupled branched-split-merge rear contract."""
...
def direct_plus_branched_split_merge_rear_path_front_chamber_throat_side_front_contribution_spl(
    sweep: SolvedFrequencySweep,
    system: AssembledSystem,
    contract: DirectPlusBranchedSplitMergeRearPathFrontChamberThroatSideContributionContract,
    distance_m: float,
    *,
    ...
    """Return the direct-front contribution SPL for one front-coupled branched-split-merge rear contract."""

    p_obs = direct_plus_branched_split_merge_rear_path_front_chamber_throat_side_front_contribution_pressure(
        sweep,
        system,
        contract,
        distance_m,
...
def direct_plus_branched_split_merge_rear_path_front_chamber_throat_side_rear_contribution_pressure(
    sweep: SolvedFrequencySweep,
    system: AssembledSystem,
    contract: DirectPlusBranchedSplitMergeRearPathFrontChamberThroatSideContributionContract,
    distance_m: float,
    *,
    ...
    """Return the coherent summed rear contribution pressure for one front-coupled branched-split-merge rear contract."""
...
def direct_plus_branched_split_merge_rear_path_front_chamber_throat_side_rear_contribution_spl(
    sweep: SolvedFrequencySweep,
    system: AssembledSystem,
    contract: DirectPlusBranchedSplitMergeRearPathFrontChamberThroatSideContributionContract,
    distance_m: float,
    *,
    ...
    """Return the coherent summed rear contribution SPL for one front-coupled branched-split-merge rear contract."""

    p_obs = direct_plus_branched_split_merge_rear_path_front_chamber_throat_side_rear_contribution_pressure(
        sweep,
        system,
        contract,
        distance_m,
